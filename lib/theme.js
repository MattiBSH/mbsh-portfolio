...
export const DANISH_PATH = "/danish_index";

export function langForPath(pathname) {
  return pathname === DANISH_PATH ? "da" : "en";
}
...
export const NO_FLASH_SCRIPT = `(function(){var d=document.documentElement;d.lang=location.pathname===${JSON.stringify(DANISH_PATH)}?"da":"en";try{var v=localStorage.getItem(${JSON.stringify(
  STORAGE_KEY
