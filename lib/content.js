...
export const EMAIL = "kontakt@mattihansen.com";
...
// Projects in the same order the timeline uses: most recent first, and an
// ongoing project ahead of one that finished in the same year it started. The
// array was hand-ordered and had already drifted (sbsys-gateway, 2025, sat
// above two 2026 projects), so the order is derived from the dates now rather
// than from where someone pasted the entry.
...
export const CONTENT = {
  en: {
    ...
    switchProjectsHref: "/danish_projects",
    switchFlag: "dk",
    ...
    projectsTeaser:
      "Municipal case management, national registry integrations and a couple of mobile apps.",
  ...
  da: {
    ...
    projectsHref: "/danish_projects",
    switchPersonalHref: "/personal",
    switchProjectsHref: "/projects",
    switchFlag: "gb",
    ...
    projectsSectionTitle: "Udvalgt arbejde",
    projectsMoreTitle: "Flere projekter",
    projectsTeaser:
      "Kommunal sagsbehandling, integrationer til de nationale registre og et par mobilapps.",
    projectsLink: "Se projekterne",
