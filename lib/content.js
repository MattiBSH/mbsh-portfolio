...
export const CONTENT = {
  en: {
    ...
    kindLabels: { internship: "Internship", student: "Student worker" },
  ...
  da: {
    ...
    skills: [
      ...
      },
      {
        ...
        body: "Jeg har arbejdet med Java og Python til at udvikle robuste og skalerbare backend-løsninger. I Java har jeg vedligeholdt eksisterende systemer og også oprettet nye fra bunden. I Python har jeg integreret med AI-modeller for at hjælpe kommuner med at håndtere GDPR-følsomme data.",
      },
      {
        title: "DevOps",
    ...
    kindLabels: { internship: "Praktik", student: "Studentermedhjælper" },
    educationTitle: "Uddannelse",
    education: [
      { title: "Borupgaard Gymnasium", period: "2016-2018" },
      { title: "Datamatiker", period: "2019-2022" },
      { title: "PBA i softwareudvikling", period: "2022-2023" },
    ],
    personal: {
